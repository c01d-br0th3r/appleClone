(() => {
  ...
  let prevScrollHeight = 0; // yOffset보다 이전에 위치한 스크롤 섹슬들의 높이값 합
  let currentScene = 0; // 현재 보고있는 섹션
  let enterNewScene = false; // 새로운 섹션 시작 = true, 음수 예외처리
  ...
  function scrollLoop() {
    ...
    // 현재 스크롤 위치가 지금까지 온 스크롤 값보다 커질 때
